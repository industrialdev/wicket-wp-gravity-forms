                ...
                try {
                    ...
                    if (window.gform && typeof window.gform.doAction === 'function') {
                        ...
                        if (fieldId) {
                            ...
                            window.gform.doAction('gform_input_change', $input, formId, fieldId);
                        } else {
                    ...
                    } else if (typeof gf_apply_rules === 'function' && $form.length) {
                    ...
                    console.log('Error applying conditional logic:', err);
                }
            }
        });
    });
    ...
    $(document).ready(function() {
        ...
        $('input.gf_org_search_select_input').each(function() {
            ...
            if ($component.length) {
                ...
                var $componentInput = $component.find('input[type="hidden"]:not(.gf_org_search_select_input)');
                if ($componentInput.length && $componentInput.val()) {
                    ...
                    if (formId && typeof formId === 'string') {
                        ...
                        try {
                            ...
                            console.log('Error triggering conditional logic on load:', err);
                        }
                    }
                }
            }
